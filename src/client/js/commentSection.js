...
const editBtn = document.querySelectorAll(".video__comment__modify");
...
const addComment = (text, id) => {
  ...
  editSpan.className = "video__comment__modify";
  const modifyIcon = document.createElement("i");
  modifyIcon.className = "fas fa-pen"
  ...
  editSpan.appendChild(modifyIcon);
  ...
  editSpan.addEventListener("click", handleCommentModifyClick);
}
...
const handleCommentModifyClick = (event) => {
  event.preventDefault();
...
editBtn.forEach(comment => {
  comment.addEventListener("click", handleCommentModifyClick);
})